public class App {
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("O endereço é: CEP:" + conta.cliente.endereco.cep + ", " + conta.cliente.endereco.rua + ", Nº" + conta.cliente.endereco.casa + ", " + conta.cliente.endereco.bairro + ".");
    }
}